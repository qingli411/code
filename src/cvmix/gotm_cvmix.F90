...
! !LOCAL VARIABLES:
   namelist /cvmix/     use_surface_layer,           &
                        ...
                        sbl_langmuir_method,         &
                        sbl_Ri_c,                    &
                        sbl_surface_layer_extent,    &
                        sbl_check_Ekman_length,      &
                        sbl_check_MonOb_length,      &
                        sbl_use_enhanced_diff,       &
                        sbl_use_noDGat1,             &
                        sbl_match_technique,         &
                        sbl_bulk_Ri_interp_type,     &
                        sbl_OBL_interp_type,         &
                        bbl_Ri_c,                    &
                        bbl_surface_layer_extent,    &
                        bbl_check_Ekman_length,      &
...
!  CVMix - 'cvmix' namelist
   ...
   sbl_langmuir_method = 0
   sbl_surface_layer_extent = 0.1
   sbl_Ri_c = 0.3
   sbl_check_Ekman_length = .false.
   sbl_check_MonOb_length = .false.
   sbl_use_enhanced_diff = .true.
   sbl_use_noDGat1 = .true.
   sbl_match_technique = 1
   sbl_bulk_Ri_interp_type = 2
   sbl_OBL_interp_type = 4
   bbl_surface_layer_extent = 0.1
   bbl_Ri_c = 0.3
   bbl_check_Ekman_length = .false.
   bbl_check_MonOb_length = .false.
   bbl_use_noDGat1 = .true.
   bbl_match_technique = 1
   bbl_bulk_Ri_interp_type = 2
   bbl_OBL_interp_type = 4
   ! background
